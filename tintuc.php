...
<div class="uk-container">
    ...
    <nav class="" aria-label="Breadcrumb">
        <ul class="breadcrumb uk-breadcrumb uk-margin-remove">
            ...
            <li><span aria-current="page">tin tức</span></li>
        </ul>
    </nav>
        ...
        <div class="uk-width-expand">
            <div class="uk-flex-middle uk-grid uk-grid-12" uk-grid>
                <div class="uk-width-auto">
                    <h2 class="common__title fz-36 be-vietnam-pro-semibold">Tin tức</h2>
                </div>
                <div class="uk-width-expand">
                ...
                <div class="uk-width-auto">
                    <form class="danhmucsach__search uk-search uk-search-default width-284px">
                        ...
                        <input class="danhmucsach__search__input uk-search-input uk-border-pill" type="search" placeholder="Tìm kiếm tin tức" aria-label="Tìm kiếm tin tức">
                    </form>
                </div>
            </div>
            <?php for ($i = 0; $i < 8; $i++) { ?>
                <div class="uk-grid uk-grid-36" uk-grid>
                    <div class="uk-width-auto">
                        <div class="uk-cover-container border-10">
                            <img src="https://picsum.photos/220/153/?random=<?= $i ?>" alt="" uk-cover="">
                            <canvas width="220" height="153"></canvas>
                            <a href="" class="uk-position-cover"></a>
                        </div>
                    </div>
                    <div class="uk-width-expand">
                        <h3 class="fz-20 be-vietnam-pro-medium line-height-140 uk-margin-remove"><a href="" class="uk-link-toggle">Internet of Things: Connecting the World in the Digital Era</a></h3>
                        <div class="item-12px fz-16 line-height-150 text-5E5D5A">Lorem ipsum dolor sit amet consectetur. At enim penatibus purus purus rutrum arcu eget mattis nulla. Adipiscing mauris amet nullam lobortis blandit. Nec nullam pellentesque dolor consectetur ut cursus. Dui urna orci at aliquam adipiscing.</div>
                    </div>
                </div>
            <?php } ?>
