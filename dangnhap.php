        ...
        <div class="uk-child-width-1-2 uk-flex-middle" uk-grid>
            ...
            <div>
                <div class="uk-form-stacked uk-card uk-card-body uk-padding-remove-top uk-padding-remove-bottom">
                    ...
                    <div class="uk-text-center fz-14 be-vietnam-pro-medium uk-margin-top" style="color: #6B6B6B;">Bạn chưa có tài khoản? <a href="" style="text-decoration: underline; color: #000;" class="be-vietnam-pro-semibold">Đăng ký</a></div>
                </div>
            </div>
        </div>
    </div>
