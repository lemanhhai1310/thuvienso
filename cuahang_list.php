    ...
    <div class="uk-container">
        <div class="uk-flex-middle" uk-grid>
            <div class="uk-width-expand">
                <h1 class="uk-margin-remove fz-54 line-height-126 sora-600 uk-text-capitalize">Cửa hàng</h1>
                <nav class="item-9px" aria-label="Breadcrumb">
                    <ul class="breadcrumb uk-breadcrumb uk-margin-remove">
                        <li><a href=".">Trang chủ</a></li>
                        <li><span aria-current="page">Cửa hàng</span></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="uk-grid-medium" uk-grid>
        <div class="uk-width-auto">
            <div class="width-258px" uk-sticky="offset: 72;start: 1;end: !.uk-container;">
                <div class="cuahang__fillter__card uk-card border-15">
                    <h3 class="cuahang__fillter__title fz-16 be-vietnam-pro-semibold line-height-150">Xu hướng</h3>
                    <div class="uk-grid-16 uk-child-width-1-1 uk-grid" uk-grid>
                        ...
                        for ($i = 0; $i < count($data); $i++) { ?>
                            <label class="cuahang__fillter__labelCheck uk-flex uk-flex-middle">
                                ...
                                <span class="uk-label <?= ($i==0)? 'uk-label-danger':'uk-label-success' ?> uk-border-pill fz-10 header__bottom__label"><?= ($i==0)? 'HOT':'MỚI' ?></span>
                            </label>
                        <?php } ?>
                    </div>
                </div>
                <div class="cuahang__fillter__card uk-card border-15 uk-margin">
                    <h3 class="cuahang__fillter__title fz-16 be-vietnam-pro-semibold line-height-150">Danh mục</h3>
                    <div class="uk-grid-16 uk-child-width-1-1 uk-grid" uk-grid>
                        <?php
                        $data = [
                            'Phiêu lưu, hành động',
        ...
        <div class="uk-width-expand">
            <div class="uk-flex-middle" uk-grid>
                <div class="uk-width-expand">
                    <h3 class="fz-18 sora-600 line-height-150">Danh sách tác phẩm <span style="color: #966412;">(4382)</span></h3>
                </div>
                <div class="uk-width-auto">
                    <div class="uk-grid-divider uk-grid-medium" uk-grid>
                        ...
                        <div>
                            <div class="uk-flex uk-flex-middle" style="gap: 10px">
                                <a href="cuahang.php" class="cuahang__icon cuahang__icon--grid"></a>
                                <a href="cuahang_list.php" class="cuahang__icon cuahang__icon--list"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="uk-child-width-1-1 uk-grid-30 uk-grid" uk-grid>
                <?php
                $name = [
                    'Marvin McKinney',
                    'Kristin Watson',
                ...
                for ($i = 0; $i < count($name); $i++) { ?>
                    <div class="uk-inline-clip uk-transition-toggle">
                        <div class="uk-grid uk-grid-42 uk-flex-middle" uk-grid>
                            <div>
                            ...
                            <div>
                                <div class="item-15px width-597px">
                                    ...
                                    <div class="item-8px fz-14 be-vietnam-pro-light line-height-142 text-444">Est numquam harum aut ut. Pariatur cum blanditiis est delectus accusamus eveniet. Quis
                                        fugiat eligendi magni eos dignissimos numquam.</div>
                                    <div class="item-8px text-999 fz-12 be-vietnam-pro-semibold line-height-133">McGraw-Hill Education</div>
                                    <div class="item-28px">
