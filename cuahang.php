            ...
            <div class="uk-child-width-1-4 uk-grid-24" uk-grid>
                ...
                for ($i = 0; $i < count($name); $i++) { ?>
                    <div class="uk-inline-clip uk-transition-toggle row-gap-30">
                        ...
                        <div class="item-15px">
                            <h6 class="fz-18 be-vietnam-pro-semibold uk-margin-remove line-height-133 uk-text-truncate"><a href="" class="uk-link-toggle be-vietnam-pro-semibold"><?= $name[$i]; ?></a></h6>
                            <div class="item-8px">
